...
export const BarIndicator: React.FC<BarIndicatorProps> = ({
  ...
  const targetHeightPercent = (value / maxValue) * 100;
  ...
  return (
    <div className={classes["bar-container"]}>
      ...
      ></div>
      <div
        className={classes["bar-bottom"]}
        style={{
          backgroundColor: color,
        }}
      >
        <div className={classes["bar-bottom-content"]}>
          {Shape && <div className={classes["shape-wrapper"]}>{Shape}</div>}
